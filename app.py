...
TEXT_TRANSLATIONS = {
    ...
    "en": {
        ...
        "Rapporto presenze": "Attendance report",

        "Collaboratore": "Employee",

        "Periodo": "Period",

        "Dettaglio ore registrate": "Logged hours detail",

        "Totale ore": "Total hours",

        "Firma del collaboratore": "Employee signature",

        "Firma responsabile azienda": "Company representative signature",
